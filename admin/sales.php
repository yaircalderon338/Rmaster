...
<html lang="es">
  ...
  <body id="page-top">
                      ...
                      while($orderRow = $orderResult->fetch_array(MYSQLI_ASSOC)) {
                        ...
                        if ($currentspan == $rowspan) {
                          ...
                          switch ($orderRow['status']) {
                            case 'waiting': $color = "badge badge-warning"; break;
                            case 'preparing': $color = "badge badge-primary"; break;
                            case 'ready': $color = "badge badge-success"; break;
                            case 'cancelled': $color = "badge badge-danger"; break;
                            case 'finish': $color = "badge badge-success"; break;
                            case 'Completed': $color = "badge badge-success"; break;
                          }
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="logoutModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">Selecciona "Cerrar Sesión" para cerrar tu sesión.</div>
    ...
    <!-- JavaScript for the alert confirmation and notification -->
    <script>
      document.getElementById("clearBtn").addEventListener("click", function() {
        var confirmation = confirm("¿Estás seguro de que deseas limpiar los cambios?");
        if (confirmation) {
          alert("Los cambios han sido limpiados exitosamente.");
          location.reload();
        }
      });
    </script>
